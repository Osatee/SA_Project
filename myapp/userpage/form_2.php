...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (
        ...
        $topic_id = 2; // topic_id 1 สำหรับแบบประเมินด้านการทำงาน
        ...
        if ($conn) {
            try {
                ...
                if ($stmt->execute()) {
                    echo "<script>alert('การประเมินสำเร็จ!'); window.location.href='form_2.php';</script>";
                } else {
        ...
        <div class="container-fluid">
            <div class="container-fluid">
                <form action="" method="POST">
                    <div class="form-group">
                        ...
                        <select name="employee" id="employee" required>
                            ...
                            <?php
                                $conn = getDBConnection();
                                if ($conn) {
                                    // ปรับ query ให้แสดงเฉพาะ fname ของ p_id ที่ pos_id = 2
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title fw-semibold mb-4">แบบประเมินในด้านความประพฤติ</h5>

                            <!-- Questions -->
                            <?php
                            $questions = [
                                "ใจดี เข้าถึงง่าย พูดคุยง่าย ปรึกษา",
                                "เป็นแกนนำในการทำงาน กล้าตอบ กล้าแย้ง",
                                "เป็นที่รักของคนอื่นทั้งในแผนกและนอกแผนก เป็นเพื่อนที่ดีในและนอกเวลางาน",
                                "มีการพัฒนาข้อเสียอยู่ตลอด พร้อมเรียนรู้สิ่งใหม่และการนำมาใช้",
                                "ความเอื้อเฟื้อทั้งเรื่องงานและชีวิตจริง ช่วยเหลือไม่หวังผลตอบแทน",
                                "พร้อมเรียนรู้กับเรื่องใหม่ มีความท้าทายในประสบการณ์ที่ไม่เคยทำ",
                                "เต็มที่กับงานหรือสิ่งที่ทำอยู่เสมอ"
                            ];
                            for ($q = 1; $q <= 7; $q++) { ?>
                                <div class="mb-3">
